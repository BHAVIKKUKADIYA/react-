            ...
            jobOpenings.map(function(elem){
              return <Card 
                      company={elem.companyName}
                       post={elem.post} date={elem.datePosted} 
...
export default App;
//aapde app.jsx file ma component banavyo and export karyu.
//pachi main.jsx file ma app ne import kari ne render karyu.
//app.jsx file ma react import karvu jaruri chhe. also yts value never read error na ave te mate react ne import karvu jaruri chhe.
//return ni andar ek j parent element hovanu jaruri chhe. ahiya div id="parents" e parent element chhe.


//props dilling thi ame component ne dynamic banaavi sakie chhe. je rite ahiya card component ma user, age and img props pass karyu chhe.
//aama kai ni props pass karvanu gamei name rakhi sakiye pachi culry backet ma je name rkahu hoi janeke
//  props arakhiyu to props . gamei name sje pass karvu hoi ae rakhi devanu ane aeni vlaue app.jsx/ 
// jenama ae components call karavyu jhoi aena ma ae valuew dei devani